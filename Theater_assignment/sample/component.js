Vue.component('navbar', {
  ...
  <nav style="z-index:2;text-align: right;background-color:tranparent">
    ...
    <li <button type='button' class="btn btn-success btn-lg" data-toggle="modal" data-target="#popUpWindow"
    style="background-color:orange;border-color: orange;color: black;">Sign in / Sign up</button>
    </li>
    </ul>
</nav>
      ...
      <div class="modal-dialog" style="margin-top:30vh;text-align:center">
          <div class="modal-content">
              ...
              <div class="modal-footer">
                  ...
                  <button class="btn btn-primary btn-block btn-lg" onClick="login()" style="background-color:black;border-color:black" id="signIn">Sign In</button>
              </div>
